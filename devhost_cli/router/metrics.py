...
class Metrics:
    ...
    def record(self, subdomain: str | None, status_code: int, latency_ms: float | None = None) -> None:
        """
    ...
    def get_error_rate(self) -> float:
        ...
        error_count = sum(count for status, count in self.requests_by_status.items() if status >= 400)
