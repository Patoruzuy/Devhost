...
import unittest
from devhost_cli.validation import validate_name, MAX_ROUTE_NAME_LENGTH
...
class TestHostnameLengthLimits(unittest.TestCase):
    ...
    def test_max_hostname_valid(self):
        ...
        label1 = "aa"  # 2 chars
        label2 = "b" * 62  # 62 chars
        label3 = "c" * 62  # 62 chars
        label4 = "d" * 62  # 62 chars
        label5 = "e" * 62  # 62 chars
