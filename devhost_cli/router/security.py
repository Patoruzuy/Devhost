...
def validate_upstream_target(host: str, port: int) -> tuple[bool, Optional[str]]:
    ...
    for family, socktype, proto, canonname, sockaddr in addr_info:
        ...
        for network in BLOCKED_NETWORKS:
            if ip_obj in network:
                ...
                return (False, f'Target {host} resolves to private IP {ip_str} (SSRF protection). Use DEVHOST_ALLOW_PRIVATE_NETWORKS=1 to override.')
